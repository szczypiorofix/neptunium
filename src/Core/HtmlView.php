...
class HtmlView
{
    public const VIEWS_PATH = './src/views';
    public const COMMENTS_PATH = './src/views/components';
    ...
    {
        return self::renderView(self::VIEWS_PATH, $view, $params);
    }

    public static function renderComponent(string $view, array $params = []): string
    {
        return self::renderView(self::COMMENTS_PATH, $view, $params);
    }
